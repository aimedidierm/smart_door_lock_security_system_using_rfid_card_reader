...
if(isset($_POST['save'])){
    ...
    $card=$_POST['card'];
    $sql ="INSERT INTO user (email,names,phone,address,card) VALUES (?,?,?,?,?)";
    $stm = $db->prepare($sql);
    if ($stm->execute(array($email,$names,$phone,$address,$card))) {
            ...
            <div class="row">
                <div class="col-lg-6">
                    <form method="post">
                        ...
                        <div class="form-group">
                            <label>Card</label>
                            <input class="form-control" type="password" name="card" required>
                        </div>
                        <div class="form-group">
                        <button type="submit" class="btn btn-info" name="save"><span class="glyphicon glyphicon-check"></span> Save</button>
                        </div>
                    </form>
                </div>
            </div>
